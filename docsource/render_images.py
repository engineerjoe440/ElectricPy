...
def render_power_triangle():
    ...
    plt.savefig(f"{FIGURE_DIRECTORY}/PowerTriangle.png")
...
def render_motor_circle():
    ...
    plt.savefig(f"{FIGURE_DIRECTORY}/InductionMotorCircleExample.png")
...
def render_receiving_end_power_circle():
    ...
    plt.savefig(f"{FIGURE_DIRECTORY}/ReceivingEndPowerCircleExample.png")
...
def render_receiving_power_circle():
    ...
    plt.savefig(f"{FIGURE_DIRECTORY}/ReceivingPowerCircleExample.png")
...
def render_convbar_example():
    ...
    plt = ep.convbar(h, x)
    plt.savefig(f"{FIGURE_DIRECTORY}/convbar-example.png")
