...
class InductionMotorCircle:
    ...
    .. image:: /static/induction_motor.png
...
def receiving_end_power_circle(
    ...
    try:
        ...
        raise ValueError(
            "Not enough attributes to build Receiving end power circle \
    ...
    try:
        ...
        raise ValueError(
            "Not enough attributes for marking an operating point on \
...
def sending_end_power_circle(
    ...
    try:
        ...
        raise ValueError(
            "Not enough attributes to build Sending end power circle \
